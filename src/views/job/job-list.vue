<template>
    <Layout class="personnel-list" :title="'找工作'">
        ...
        <div class="list-box">
            <van-list v-model="loading" :finished="finished" @load="getPersons">
                <s-jobs ref="talentsComp" :choosedFromTop="choosed" @choosedTalent="choosedTalent" :showCheck="true"
                           :list="list"/>
            </van-list>
        </div>
        <div class="apply all bb">
            ...
            <span class="sq" @click="applyFun">申请职位</span>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                keySets: ['releaseDate','expectedSalary','wrokLife','education', 'natureOfCompany', 'companySize'],
                filters: [
                    {
                        text: '发布日期',
                        key: 'releaseDate',
        ...
        methods: {
            ...
            confirmFilter() {
                ...
                this.queryOptions.natureOfCompany = this.queryOptionsTemp.natureOfCompany
                this.queryOptions.companySize = this.queryOptionsTemp.companySize
            },
            cancelFilter() {
                this.filterShow = false
                ...
                this.queryOptionsTemp.natureOfCompany = this.queryOptions.natureOfCompany
                this.queryOptionsTemp.companySize = this.queryOptions.companySize
            },
            onNavClick(index) {
