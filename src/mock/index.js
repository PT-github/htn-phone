...
Mock.mock(/\/position\/addCompanyJob/, 'post', api.queryPubJobs)
...
Mock.mock(/\/vitae\/deleteCollectById/, 'post', api.queryInterviewList)
Mock.mock(/\/interview\/deleteInterviewById/, 'post', api.queryInterviewList)
...
Mock.mock(/\/positionapply\/deleteApplyRecordList/, 'post', api.queryNetWorkTalentList)
Mock.mock(/\/talent\/deleteOwnTalentList/, 'post', api.queryNetWorkTalentList)
Mock.mock(/\/talent\/deleteNetWorkTalentList/, 'post', api.queryNetWorkTalentList)
